...
import com.example.telegramclone.utils.WRITE_FILES
import com.example.telegramclone.utils.asTime
import com.example.telegramclone.utils.checkPermission
...
class HolderFileMessage(view: View) : RecyclerView.ViewHolder(view), MessageHolder {
    ...
    private val chatUserFileMessageTime:
            TextView = view.findViewById(R.id.chat_user_file_message_time)
